        ...
        start: function(username) {
            ...
            if(username && !this.game.started) {
                ...
                if(config.local) {
                    ...
                    this.game.setServerOptions(config.local.host, config.local.port, username, config.local.secure);
                } else {
                    log.debug("Starting game with default dev config.");
                    this.game.setServerOptions(config.dev.host, config.dev.port, username, config.dev.secure);
                }
                optionsSet = true;
                //>>includeEnd("devHost");
                ...
                if(!optionsSet) {
                    ...
                    this.game.setServerOptions(config.build.host, config.build.port, username, config.build.secure);
                }
                //>>includeEnd("prodHost");
